...
triggers: code forge plan, analyze, documentation, prompt, generate, implementation
---
...
Each task in the plan should be assigned to the most appropriate sub-agent:

| Agent | Responsibility |
|-------|---------------|
| **Hephaestus** | Code implementation, TDD, refactoring |
| **Oracle** | Architecture decisions, design patterns, complex debugging |
| **Librarian** | Research, documentation, external API patterns |
| **Explore** | Codebase analysis, pattern discovery |

### Task Duration Guideline
Aim for steps of ~15 minutes each. If a step exceeds this, break it further.
